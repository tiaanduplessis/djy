...
const isFunction = (func) => Object.prototype.toString.apply(func).slice(8, -1) === 'Function'
const hasSelector = function (element, selector) {
...
Djy.fn = Djy.prototype = {
  ...
  children(selector) {
    const elements = []
    this.each(element => { elements.push(element.children) })

    return !selector ? elements
      : elements.filter(element => hasSelector(element, selector))
  },
