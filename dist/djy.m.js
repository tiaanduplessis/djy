...
Djy.fn = (Djy.prototype = {
    ...
    attr: function attr(name, val) {
        if (val) {
            ...
            return this.elements.length === 1 ? this.elements[0].getAttribute(name) : this.elements.map(function (element) { return element.getAttribute(name); });
        }
        return this;
    },
    val: function val(val$1) {
        if (val$1) {
            ...
            return this.elements.length === 1 ? this.elements[0].value : this.elements.map(function (element) { return element.value; });
        }
        return this;
    },
    ...
    html: function (html) {
        if (html) {
            ...
            return this.elements.length === 1 ? this.elements[0].innerHTML || '' : this.elements.map(function (element) { return element.innerHTML || ''; });
        }
        return this;
    },
    css: function css(rule, attr) {
        if (rule) {
            ...
            return this.elements.length === 1 ? getComputedStyle(this.elements[0])[rule] : this.elements.map(function (element) { return getComputedStyle(element)[rule]; });
        }
        return this;
    },
    text: function text(content) {
        if (!content) {
            return this.elements.length === 1 ? this.elements[0].textContent : this.elements.map(function (element) { return element.textContent; });
        }
    ...
    children: function children(selector) {
        ...
        return !selector ? elements : elements.filter(function (element) { return hasSelector(element, selector); });
    },
